CREATE TABLE transfac__transcriptional_factor__main (
       tf_id_key	int(5) unsigned NOT NULL AUTO_INCREAMENT,
       ...
       tf_chromosome_strand	    char(1) unsigned NOT NULL,
       concise_description	    text default NULL,
       PRIMARY KEY 'tf_key' (tf_id_key),        
);

CREATE TABLE transfac__binding_sites__main (
       tf_id_key	int(5) unsigned NOT NULL,
       bs_id_key	int(20) unsigned NOT NULL AUTO_INCREAMENT,
       ...
       bs_chromosome_strand	char(1) unsigned NOT NULL, 
